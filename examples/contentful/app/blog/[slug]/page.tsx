...
import { BlogFeedQueryVariables, GetBlogsDocument } from '@/generated/contentful'
...
export async function generateStaticParams() {
  const { blogCollection } = await client.request(GetBlogsDocument, DEFAULT_PARAMS)
...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  return (
    <SWRProvider
      fallback={{
        [`blog/${slug}`]: await client.request(GetBlogsDocument, {
          filter: { slug },
        }),
      }}
    >
